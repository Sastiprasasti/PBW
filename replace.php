...
<meta charset="utf-8">
	...
	<title>Mission Simerka - Replace</title>
    <style>
...
<header>
    ...
    <div class="top-wrapper">
      <div class="container">
        <h1>Upload Replace Mission Simerka</h1>
        ...
        <form action = "" method="post" enctype="multipart/form-data">
          ...
          <li>
            ...
            <li>
              <input type="hidden" name="namamisi" id="namamisi" value="Replace" readonly="readonly">
            </li>
