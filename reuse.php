...
<meta charset="utf-8">
	...
	<title>Mission Simerka - Reuse</title>
    <style>
         ul,li {
...
<header>
    ...
    <div class="top-wrapper">
      <div class="container">
        <h1>Upload Reuse Mission Simerka</h1>
        ...
        <form action = "" method="post" enctype="multipart/form-data">
          ...
          <li>
            ...
            <li>
              <input type="hidden" name="namamisi" id="namamisi" value="Reuse" readonly="readonly">
            </li>
